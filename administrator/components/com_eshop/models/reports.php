...
class EShopModelReports extends JModelLegacy
{
	...
	private function _getPurchasedProductsQuery()
	{
		...
		$db = $this->getDbo();
		$query = $db->getQuery(true);
		$query->select('a.id, a.product_id, a.product_sku, a.product_name, b.product_taxclass_id, SUM(a.quantity) AS quantity, SUM(a.total_price) AS total_price, b.product_price, b.product_cost')
