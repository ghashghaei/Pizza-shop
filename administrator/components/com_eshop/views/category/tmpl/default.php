	...
	if ($translatable)
	{
		...
		foreach ($this->languages as $language)
		{
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-xlarge" type="text" name="category_alt_image_<?php echo $langCode; ?>" id="category_alt_image_<?php echo $langId; ?>" size="" maxlength="250" value="<?php echo isset($this->item->{'category_alt_image_'.$langCode}) ? $this->item->{'category_alt_image_'.$langCode} : ''; ?>" />
				</div>								
			</div>
			<div class="control-group">
				<div class="control-label">
