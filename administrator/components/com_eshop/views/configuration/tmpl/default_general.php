...
<div class="control-group">
	...
	<div class="controls">
		<input class="text_area" type="text" name="telephone" id="telephone" size="10" value="<?php echo $this->config->telephone; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('debug_mode', JText::_('ESHOP_CONFIG_DEBUG_MODE'), JText::_('ESHOP_CONFIG_DEBUG_MODE_HELP')); ?>
		</div>
		<div class="controls">
