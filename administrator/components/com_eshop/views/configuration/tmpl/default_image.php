...
<div class="control-group">
	<div class="control-label">
		<?php echo JText::_('ESHOP_RESIZED_IMAGE_BACKGROUND'); ?>
	</div>
	<div class="controls">
		<input type="text" name="resized_image_background" class="inputbox color {required:false}" value="<?php echo isset($this->config->resized_image_background) ? $this->config->resized_image_background : 'FFFFFF'; ?>" size="5" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
		<?php echo EshopHtmlHelper::getFieldLabel('product_image_rollover', JText::_('ESHOP_PRODUCT_IMAGE_ROLLOVER'), JText::_('ESHOP_PRODUCT_IMAGE_ROLLOVER_HELP')); ?>
	</div>
	<div class="controls">
