...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('theme', JText::_('ESHOP_CONFIG_CART_NOTIFY'), JText::_('ESHOP_CONFIG_CART_NOTIFY_HELP')); ?>
		</div>
		<div class="controls">
...
<div class="span6">
	<fieldset class="form-horizontal">
		...
		<div class="control-group">
			<div class="control-label">
				<?php echo EshopHtmlHelper::getFieldLabel('grid_ratio_image_info', JText::_('ESHOP_CONFIG_GRID_RATIO_IMAGE_INFO'), JText::_('ESHOP_CONFIG_GRID_RATIO_IMAGE_INFO_HELP')); ?>
			</div>
			<div class="controls">
