...
<div class="control-group">
	<div class="control-label">
		<span class="required">*</span><?php echo JText::_('ESHOP_CONFIG_CURRENCY_CONVERT_API_KEY'); ?><br />
		<span class="help"><?php echo JText::_('ESHOP_CONFIG_CURRENCY_CONVERT_API_KEY_HELP'); ?></span>
	</div>
	<div class="controls">
		<input class="input-large" type="text" name="currency_convert_api_key" id="currency_convert_api_key"  value="<?php echo isset($this->config->currency_convert_api_key) ? $this->config->currency_convert_api_key : 'd3d91dd1c0af62db625b'; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
