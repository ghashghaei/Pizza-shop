...
<div class="span12">
	<fieldset class="form-horizontal">
		...
		<div class="control-group">
			<div class="control-label">
				<?php echo EshopHtmlHelper::getFieldLabel('product_alert_emails', JText::_('ESHOP_CONFIG_PRODUCT_ALERT_MAILS'), JText::_('ESHOP_CONFIG_PRODUCT_ALERT_MAILS_HELP')); ?>
			</div>
			<div class="controls">
				<input class="text_area" type="text" name="product_alert_emails" id="product_alert_emails" size="100" maxlength="250" value="<?php echo isset($this->config->product_alert_emails) ? $this->config->product_alert_emails : ''; ?>" />
			</div>
		</div>
	</fieldset>
</div>