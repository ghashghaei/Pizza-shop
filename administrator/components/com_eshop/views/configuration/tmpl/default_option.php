...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('shop_offline', JText::_('ESHOP_CONFIG_SHOP_OFFLINE'), JText::_('ESHOP_CONFIG_SHOP_OFFLINE_HELP')); ?>
		</div>
		<div class="controls">
	...
	if (version_compare(JVERSION, '3.0', 'ge') && JLanguageMultilang::isEnabled() && count(EshopHelper::getLanguages()) > 1)
	{
		...
		for ($i = 0; $i < count($languages); $i++)
		{
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EshopHtmlHelper::getFieldLabel('default_menu_item_' . $languages[$i]->lang_code, JText::_('ESHOP_CONFIG_DEFAULT_MENU_ITEM') . ' (' . $languages[$i]->title . ')', JText::_('ESHOP_CONFIG_DEFAULT_MENU_ITEM_HELP') . ' (' . $languages[$i]->title . ')'); ?>
				</div>
				<div class="controls">
...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('product_sku_validation', JText::_('ESHOP_CONFIG_PRODUCT_SKU_VALIDATION'), JText::_('ESHOP_CONFIG_PRODUCT_SKU_VALIDATION_HELP')); ?>
		</div>
		<div class="controls">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('dynamic_info', JText::_('ESHOP_CONFIG_DYNAMIC_INFO'), JText::_('ESHOP_CONFIG_DYNAMIC_INFO_HELP')); ?>
		</div>
		<div class="controls">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('display_option_price_with_tax', JText::_('ESHOP_CONFIG_DISPLAY_OPTION_PRICE_WITH_TAX'), JText::_('ESHOP_CONFIG_DISPLAY_OPTION_PRICE_WITH_TAX_HELP')); ?>
		</div>
		<div class="controls">
...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('display_privacy_policy', JText::_('ESHOP_DISPLAY_PRIVACY_POLICY'), JText::_('ESHOP_DISPLAY_PRIVACY_POLICY_HELP')); ?>
		</div>
		<div class="controls">
...
<fieldset class="form-horizontal">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('checkout_weight', JText::_('ESHOP_CONFIG_DISPLAY_WEIGHT_ON_CHECKOUT_PAGE'), JText::_('ESHOP_CONFIG_DISPLAY_WEIGHT_ON_CHECKOUT_PAGE_HELP')); ?>
		</div>
		<div class="controls">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('enable_existing_addresses', JText::_('ESHOP_CONFIG_ENABLE_EXISTING_ADDRESSES'), JText::_('ESHOP_CONFIG_ENABLE_EXISTED_ADDRESSES_HELP')); ?>
		</div>
		<div class="controls">
	...
	if (version_compare(JVERSION, '3.0', 'ge') && JLanguageMultilang::isEnabled() && count(EshopHelper::getLanguages()) > 1)
	{
		...
		for ($i = 0; $i < count($languages); $i++)
		{
			...
			<div class="control-group">
        		<div class="control-label">
        			<?php echo EshopHtmlHelper::getFieldLabel('continue_shopping_url_' . $langCode, JText::_('ESHOP_CONFIG_CONTINUE_SHOPPING_URL') . ' (' . $languages[$i]->title . ')', JText::_('ESHOP_CONFIG_CONTINUE_SHOPPING_URL_HELP') . ' (' . $languages[$i]->title . ')'); ?>
        		</div>
        		<div class="controls">
        			<input class="input-xxlarge" type="text" name="continue_shopping_url_<?php echo $langCode; ?>" id="continue_shopping_url_<?php echo $languages[$i]->lang_code; ?>"  value="<?php echo isset($this->config->{'continue_shopping_url_' . $langCode}) ? $this->config->{'continue_shopping_url_' . $langCode} : ''; ?>" />
        		</div>
        	</div>
			<?php
		}
...
<fieldset class="form-horizontal">
	<legend><?php echo JText::_('ESHOP_CONFIG_INVENTORY'); ?></legend>
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('stock_manage', JText::_('ESHOP_CONFIG_MANAGE_STOCK'), JText::_('ESHOP_CONFIG_MANAGE_STOCK_HELP')); ?>
		</div>
		<div class="controls">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EshopHtmlHelper::getFieldLabel('threshold', JText::_('ESHOP_CONFIG_THRESHOLD'), JText::_('ESHOP_CONFIG_THRESHOLD_HELP')); ?>
		</div>
		<div class="controls">
			<input class="input-mini" type="text" name="threshold" id="threshold" value="<?php echo isset($this->config->threshold) ? $this->config->threshold : '0'; ?>" />
		</div>
	</div>
</fieldset>
<fieldset class="form-horizontal">
