...
class EshopViewCoupon extends EShopViewForm
{
	function _buildListArray(&$lists, $item)
	{
		...
		$lists['coupon_for_free_shipping']    = EshopHtmlHelper::getBooleanInput('coupon_for_free_shipping', isset($item->coupon_for_free_shipping) ? $item->coupon_for_free_shipping : '0');
		//Get history coupon
		$query->clear();
		$query->select('*')
