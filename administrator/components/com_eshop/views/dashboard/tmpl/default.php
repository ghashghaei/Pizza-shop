...
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=products">
<span class="el-image uk-text-muted" uk-icon="icon: image; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">محصولات</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام محصولات</div>
</a>
</div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=categories">
<span class="el-image uk-text-muted" uk-icon="icon: album; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">گروه ها</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام گروه ها</div>
</a>
</div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=manufacturers">
<span class="el-image uk-text-muted" uk-icon="icon: uikit; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">برندها</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام برندها</div>
</a>
</div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=reviews">
<span class="el-image uk-text-muted" uk-icon="icon: comments; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">نظرات</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام نظرها</div>
</a></div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=orders">
<span class="el-image uk-text-muted" uk-icon="icon: cart; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">سفارشات</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام سفارشات</div>
</a>
</div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=quotes">
<span class="el-image uk-text-muted" uk-icon="icon: future; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">پیش خرید ها</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام پیش خریدها</div>
</a>
</div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=notify">
<span class="el-image uk-text-muted" uk-icon="icon: bell; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">موجود شد خبر بده</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام درخواست ها</div>
</a></div>
<div>
<a class="el-item uk-card uk-card-default uk-card-hover uk-card-body uk-margin-remove-first-child uk-display-block uk-link-toggle" href="index.php?option=com_eshop&view=customers">
<span class="el-image uk-text-muted" uk-icon="icon: users; ratio: 3;"></span>
<h4 class="el-title uk-margin-top uk-margin-remove-bottom">مشتریان</h4>
<div class="el-meta uk-text-meta uk-margin-top">لیست تمام مشتریان</div>
</a>
</div>
</div>
</div>
...
<div class="uk-grid-small uk-grid-margin-small" uk-grid>
	...
	<div class="uk-grid-item-match uk-width-expand@m">
		<div class="uk-card uk-card-default bs-example bs-shop-statistics">
						...
						if (EshopHelper::getConfigValue('show_eshop_update', 0))
						{
							...
							<td>
								<div id="cpanel">
									<div id="update-check">
										<div class="icon">
											<a href="index.php?option=com_installer&view=update" title="<?php echo JText::_('ESHOP_UPDATE_CHECKING'); ?>">
		...
		<div class="uk-card uk-card-default bs-example bs-recentorders">
			<table class="table dashboard-table">
				<thead>
					<tr>
							...
							<tr>
								...
								<td>
									...
									if ($order->created_date != $this->nullDate)
										echo JHtml::_('date', $order->created_date,EshopHelper::getConfigValue('date_format', 'm-d-Y'), null);
									?>
								</td>
...
<div class="uk-grid-small uk-grid-margin-small" uk-grid>
<div class="uk-grid-item-match uk-width-expand@m">		
		<div class="uk-card uk-card-default bs-example bs-top-sales">
			<table class="table dashboard-table">
				<thead>
					<tr>
...
<div class="uk-grid-item-match uk-width-expand@m">		
		<div class="uk-card uk-card-default bs-example bs-top-hits">
			<table class="table dashboard-table">
				<thead>
					<tr>
						<th style="width: 70%;"><?php echo JText::_('ESHOP_PRODUCT'); ?></th>
	...
	<div class="uk-grid-item-match uk-width-expand@m">
		<div class="uk-card uk-card-default bs-example bs-monthlyreport">
			<table class="table dashboard-table">
				<tbody>
					<tr>
						<td>
		...
		<div class="uk-card uk-card-default bs-example bs-recentreviews">
			<table class="table dashboard-table">
				<thead>
					<tr>
							...
							<tr>
								...
								<td>
									...
									if ($review->created_date != $this->nullDate)
										echo JHtml::_('date', $review->created_date, EshopHelper::getConfigValue('date_format', 'm-d-Y'), null);
									?>
								</td>
