...
class EShopViewExports extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		$options[] = JHtml::_('select.option', 'xlsx', JText::_('ESHOP_EXPORT_FORMAT_XLSX'));
		$options[] = JHtml::_('select.option', 'xml', JText::_('ESHOP_EXPORT_FORMAT_XML'));
		$lists['export_format'] = JHtml::_('select.genericlist', $options, 'export_format', ' class="inputbox" ', 'value', 'text', $input->getString('export_format', 'csv'));
