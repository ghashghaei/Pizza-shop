		...
		<table class="adminlist table table-striped" id="recordsList">
			<thead>
				<tr>
					...
					<th class="text_left">
						<?php echo JHtml::_('searchtools.sort',  'ESHOP_TITLE', 'b.title', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="text_center">
						<?php echo JHtml::_('searchtools.sort',  'ESHOP_FIELD_TYPE', 'a.fieldtype', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>			
					<th class="text_center">
