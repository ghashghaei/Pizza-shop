	...
	<div id="j-main-container">
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input style="width: 120px;" type="text" name="search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->search); ?>" class="hasTooltip" title="<?php echo JHtml::tooltipText('ESHOP_SEARCH_ORDERS_DESC'); ?>" />
			</div>
		...
		<table class="adminlist table table-striped">
			...
			<tr>
				...
				?>
					<th width="10%" class="text_center">
    					<?php echo JHtml::_('grid.sort',  JText::_('ESHOP_INVOICE_NUMBER'), 'a.invoice_number', $this->lists['order_Dir'], $this->lists['order'] ); ?>
    				</th>	
				<?php
				}
				?>
			...
			for ($i=0, $n=count( $this->items ); $i < $n; $i++)
			{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td class="text_center">
						...
						{
							echo JHtml::_('date', $row->modified_date,EshopHelper::getConfigValue('date_format', 'm-d-Y'), null);
						}							
						?>
					</td>
					<td class="text_center">
