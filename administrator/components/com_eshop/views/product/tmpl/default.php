...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form form-horizontal">
	...
	echo JHtml::_('bootstrap.addTab', 'product', 'data-page', JText::_('ESHOP_DATA', true));
	echo $this->loadTemplate('data');
	echo JHtml::_('bootstrap.endTab');
	
	echo JHtml::_('bootstrap.addTab', 'product', 'inventory-page', JText::_('ESHOP_INVENTORY', true));
	...
	<div id="date_html_container" style="display: none;">
		<?php echo JHtml::_('calendar', '', 'tmp_date_picker_name', 'tmp_date_picker_id', '%Y-%m-%d', array('class' => 'input-medium')); ?>
	</div>
</form>