...
<table class="adminlist table table-bordered" style="text-align: center;">
	<thead>
	<tr>
		<th class="text_center" width="15%"><?php echo JText::_('ESHOP_CUSTOMER_GROUP'); ?></th>
		<th class="text_center" width="10%"><?php echo JText::_('ESHOP_QUANTITY'); ?></th>
		<th class="text_center" width="10%"><?php echo JText::_('ESHOP_PRIORITY'); ?></th>
		<th class="text_center" width="10%"><?php echo JText::_('ESHOP_PRICE'); ?></th>
		<th class="text_center" width="20%"><?php echo JText::_('ESHOP_START_DATE'); ?></th>
		<th class="text_center" width="20%"><?php echo JText::_('ESHOP_END_DATE'); ?></th>
		<th class="text_center" width="10%"><?php echo JText::_('ESHOP_PUBLISHED'); ?></th>
	...
	for ($i = 0; $n = count($this->productDiscounts), $i < $n; $i++) {
		...
		<tr id="product_discount_<?php echo $i; ?>">
			...
			<td style="text-align: center;">
				<?php echo JHtml::_('calendar', (($productDiscount->date_start == $this->nullDate) || !$productDiscount->date_start) ? '' : JHtml::_('date', $productDiscount->date_start, 'Y-m-d H:i', null), 'discount_date_start[]', 'discount_date_start_'.$i, '%Y-%m-%d %H:%M', array('class' => 'input-medium', 'showTime' => true)); ?>
			</td>
			<td style="text-align: center;">
				<?php echo JHtml::_('calendar', (($productDiscount->date_end == $this->nullDate) || !$productDiscount->date_end) ? '' : JHtml::_('date', $productDiscount->date_end, 'Y-m-d H:i', null), 'discount_date_end[]', 'discount_date_end_'.$i, '%Y-%m-%d %H:%M', array('class' => 'input-medium', 'showTime' => true)); ?>
			</td>
			<td style="text-align: center;">
