...
if ($translatable)
{
	...
	foreach ($this->languages as $language)
	{
		...
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-xlarge" type="text" name="product_page_title_<?php echo $langCode; ?>" id="product_page_title_<?php echo $langId; ?>" size="" maxlength="250" value="<?php echo isset($this->item->{'product_page_title_'.$langCode}) ? htmlspecialchars($this->item->{'product_page_title_'.$langCode}, ENT_COMPAT, 'UTF-8') : ''; ?>" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
			...
			<div class="controls">
				<input class="input-xlarge" type="text" name="product_page_heading_<?php echo $langCode; ?>" id="product_page_heading_<?php echo $langId; ?>" size="" maxlength="250" value="<?php echo isset($this->item->{'product_page_heading_'.$langCode}) ? htmlspecialchars($this->item->{'product_page_heading_'.$langCode}, ENT_COMPAT, 'UTF-8') : ''; ?>" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
			...
			<div class="controls">
				<input class="input-xlarge" type="text" name="product_alt_image_<?php echo $langCode; ?>" id="product_alt_image_<?php echo $langId; ?>" size="" maxlength="250" value="<?php echo isset($this->item->{'product_alt_image_'.$langCode}) ? $this->item->{'product_alt_image_'.$langCode} : ''; ?>" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
...
?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input class="input-xlarge" type="text" name="product_page_title" id="product_page_title" size="" maxlength="250" value="<?php echo htmlspecialchars($this->item->product_page_title, ENT_COMPAT, 'UTF-8'); ?>" />
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">
		...
		<div class="controls">
			<input class="input-xlarge" type="text" name="product_page_heading" id="product_page_heading" size="" maxlength="250" value="<?php echo htmlspecialchars($this->item->product_page_heading, ENT_COMPAT, 'UTF-8'); ?>" />
		</div>
	</div>
	<div class="control-group">
			<div class="control-label">
			...
			<div class="controls">
				<input class="input-xlarge" type="text" name="product_alt_image" id="product_alt_image" size="" maxlength="250" value="<?php echo $this->item->product_alt_image; ?>" />
			</div>
		</div>
	<div class="control-group">
		<div class="control-label">
