...
class EShopViewProduct extends EShopViewForm
{
	...
	function _buildListArray(&$lists, $item)
	{
		...
		$lists['product_manage_stock']        = EshopHtmlHelper::getBooleanInput('product_manage_stock', isset($item->product_manage_stock) ? $item->product_manage_stock : '1');
		$lists['product_stock_display']       = EshopHtmlHelper::getBooleanInput('product_stock_display', isset($item->product_stock_display) ? $item->product_stock_display : '1');
		$lists['product_stock_warning']       = EshopHtmlHelper::getBooleanInput('product_stock_warning', isset($item->product_stock_warning) ? $item->product_stock_warning : '1');
		$lists['product_inventory_global']    = EshopHtmlHelper::getBooleanInput('product_inventory_global', isset($item->product_inventory_global) ? $item->product_inventory_global : '1');
