...
class EShopViewProducts extends EShopViewList
{
	...
	public function _buildListArray(&$lists, $state)
	{
		...
		$lists['product_published'] = JHtml::_('select.booleanlist', 'product_published', ' class="inputbox" disabled ', 1);
		//Build manage stock list
		$lists['product_manage_stock'] = JHtml::_('select.booleanlist', 'product_manage_stock', ' class="inputbox" disabled ', 1);
		//Build stock display list
		$lists['product_stock_display'] = JHtml::_('select.booleanlist', 'product_stock_display', ' class="inputbox" disabled ', 1);
		//Build stock warning list
		$lists['product_stock_warning'] = JHtml::_('select.booleanlist', 'product_stock_warning', ' class="inputbox" disabled ', 1);
		...
		//Build stock checkout list
		$lists['product_inventory_global'] = JHtml::_('select.booleanlist', 'product_inventory_global', ' class="inputbox" disabled ', 1);
		//Build shipping list
	...
	protected function addToolbar()
	{
		...
		$dhtml  = $layout->render(
		    array(
		        ...
		        'icon'     => 'edit',
		        'text'     => JText::_('ESHOP_MANAGE_INVENTORY'),
		    )
        );
