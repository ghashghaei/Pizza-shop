...
<div class="uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-3@m uk-child-width-1-4@l uk-child-width-1-4@xl uk-grid-match" uk-grid>
<div>
...
<span class="el-image uk-text-muted" uk-icon="icon: file-edit; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">جدید</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: copy; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">مطالب</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: folder; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">مجموعه ها</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: tag; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">برچسب ها</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: menu; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">منو ها</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: thumbnails; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">ماژول ها</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: users; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">کاربران</h3>
...
<span class="el-image uk-text-muted" uk-icon="icon: server; ratio: 4;"></span>
<h3 class="el-title uk-margin-top uk-margin-remove-bottom">فضای هاست</h3>
...
<h3 class="uk-heading-line uk-text-center uk-margin-large"><span>اطلاعات سیستم</span></h3>

<div class="uk-container">
<div class="uk-grid-margin" uk-grid>
<div class="uk-width-1-1@m">
<div class="uk-margin">
<div class="uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-2@m uk-child-width-1-3@l uk-child-width-1-3@xl uk-grid-match" uk-grid>
...
<span class="el-image uk-text-success" uk-icon="icon: <?php echo $item->icon; ?>; ratio: 3;"></span></div>
<div class="uk-margin-remove-first-child">
<h4 class="el-title uk-text-muted uk-margin-top uk-margin-remove-bottom"><?php echo $item->title; ?></h4>        
