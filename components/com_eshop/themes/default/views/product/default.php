                    	...
                    	if (EshopHelper::getConfigValue('show_quantity_box_in_product_page'))
						{
                    		...
                    		<div class="<?php echo $inputAppendClass; ?> <?php echo $inputPrependClass; ?>">
								...
								<span class="eshop-quantity">
									<a onclick="quantityUpdate('-', 'quantity_<?php echo $this->item->id; ?>', <?php echo EshopHelper::getConfigValue('quantity_step', '1'); ?>)" class="<?php echo $btnClass; ?> btn-default button-minus" id="<?php echo $this->item->id; ?>">-</a>
									...
									<a onclick="quantityUpdate('+', 'quantity_<?php echo $this->item->id; ?>', <?php echo EshopHelper::getConfigValue('quantity_step', '1'); ?>)" class="<?php echo $btnClass; ?> btn-default button-plus" id="<?php echo $this->item->id; ?>">+</a>
								</span>
							</div>
                    		<?php
                    	}
