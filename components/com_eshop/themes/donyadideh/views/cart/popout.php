...
else
{
	...
	<div class="cart-info">
		...
		$countProducts = 0;
		?>
		<table class="table table-responsive table-bordered table-striped uk-margin-remove">
			<thead>
				<tr>
    ...
    <div class="uk-text-center bottom <?php echo $controlGroupClass; ?>">
		<div class="controls">
			<button type="button" class="uk-button uk-button-secondary" onclick="updateCart();" id="update-cart"><?php echo JText::_('ESHOP_UPDATE_CART'); ?></button>
			<a class="uk-button uk-button-primary" href="<?php echo JRoute::_(EshopRoute::getViewRoute('cart')); ?>"><?php echo JText::_('ESHOP_SHOPPING_CART'); ?></a>
			<?php
			...
			?>
			<a class="uk-button uk-button-danger" href="<?php echo $checkoutUrl; ?>"><?php echo JText::_('ESHOP_CHECKOUT'); ?></a>
		</div>
	</div>
