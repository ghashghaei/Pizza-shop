...
<div class="<?php echo $rowFuildClass; ?>">
    <div id="checkout-options">
    	<div class="checkout-heading uk-margin uk-text-success"><?php echo JText::_('ESHOP_CHECKOUT_STEP_1'); ?></div>
    	<div class="checkout-content">
		</div>
    </div>
	
    <div id="payment-address">
    	<div class="checkout-heading uk-margin uk-text-success">
    		<?php
    	...
    	<div class="checkout-content uk-margin"></div>
    </div>
    <?php
    if ($this->shipping_required)
    {
    	if (EshopHelper::getConfigValue('require_shipping_address', 1))
    	{
    		...
    		<div id="shipping-address">
    			<div class="checkout-heading uk-margin uk-text-success"><?php echo JText::_('ESHOP_CHECKOUT_STEP_3'); ?></div>
    	...
    	<div id="shipping-method">
    		<div class="checkout-heading uk-margin uk-text-success"><?php echo JText::_('ESHOP_CHECKOUT_STEP_4'); ?></div>
    ...
    <div id="payment-method">
    	<div class="checkout-heading uk-margin uk-text-success"><?php echo JText::_('ESHOP_CHECKOUT_STEP_5'); ?></div>
    	<div class="checkout-content form-horizontal"></div>
    </div>
    <div id="confirm">
    	<div class="checkout-heading uk-margin uk-text-success"><?php echo JText::_('ESHOP_CHECKOUT_STEP_6'); ?></div>
    	<div class="checkout-content"></div>
    		<?php
    				...
    				<div class="eshop-squareup-information" style="display: none;">
    			        ...
    			        <form action="<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.processOrder&Itemid=<?php echo EshopRoute::getDefaultItemId(); ?>" method="post" name="payment_method_form" id="payment_method_form" class="form form-horizontal">
    			            <div class="no_margin_left">
    	                        ...
    	                        ?>
    			                <div class="no_margin_left">
    			                	<input id="squareup-button-confirm" type="button" class="uk-button uk-button-primary" value="<?php echo JText::_('ESHOP_CONFIRM_ORDER'); ?>" />
    			                </div>
    			            </div>
