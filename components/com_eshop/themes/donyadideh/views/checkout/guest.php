...
?>
<div class="uk-margin">
	<input type="button" class="uk-button uk-button-primary" id="button-guest" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
</div>
		...
		$('#button-guest').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-guest').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},	
				complete: function() {
