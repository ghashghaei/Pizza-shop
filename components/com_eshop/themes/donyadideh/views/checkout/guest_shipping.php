...
<div class="uk-margin">
	<input type="button" class="uk-button uk-button-primary" id="button-guest-shipping" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
		...
		$('#button-guest-shipping').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},
				complete: function() {
