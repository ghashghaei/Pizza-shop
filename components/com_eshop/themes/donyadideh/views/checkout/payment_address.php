...
<div class="uk-margin uk-float-left">
	<input type="button" class="<?php echo $btnClass; ?> btn-primary <?php echo $pullRightClass; ?>" id="button-payment-address" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
		...
		$('#button-payment-address').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-payment-address').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},
				complete: function() {
