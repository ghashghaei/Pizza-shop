...
<div uk-grid>
	<div class="uk-grid-item-match uk-width-expand@m">
		<legend class="uk-text-warning"><?php echo JText::_('ESHOP_YOUR_PERSONAL_DETAILS'); ?></legend>
		<?php 
		...
		?>
		<legend class="uk-text-warning"><?php echo JText::_('ESHOP_USER_DETAILS'); ?></legend>
		<div class="<?php echo $controlGroupClass; ?>">
			<div class="<?php echo $controlsClass; ?>  docs-input-sizes">
				<input type="text" id="username" name="username" placeholder="* <?php echo JText::_('ESHOP_USERNAME');?>" />
			</div>
		</div>
		<div class="<?php echo $controlGroupClass; ?>">
			<div class="<?php echo $controlsClass; ?>  docs-input-sizes">
				<input type="password" id="password1" name="password1" placeholder="* <?php echo JText::_('ESHOP_PASSWORD'); ?>" />
			</div>
		</div>
		<div class="<?php echo $controlGroupClass; ?>">
			<div class="<?php echo $controlsClass; ?>  docs-input-sizes">
				<input type="password" id="password2" name="password2" placeholder="* <?php echo JText::_('ESHOP_CONFIRM_PASSWORD'); ?>" />
			</div>
		</div>
		<?php
	...
	<div class="uk-grid-item-match uk-width-expand@m">
		<legend class="uk-text-warning"><?php echo JText::_('ESHOP_YOUR_ADDRESS'); ?></legend>
		<?php
...
?>
	<div class="uk-margin">
		<label class="checkbox"><input type="checkbox" value="1" name="shipping_address"> <span class="uk-text-meta"><?php echo JText::_('ESHOP_SHIPPING_ADDRESS_SAME'); ?></span></label>
	</div>
<?php
}
?>
	...
	?>
	<div class="uk-margin">
	<input type="button" class="uk-button uk-button-primary" id="button-register" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
		...
		$('#button-register').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-register').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},
				complete: function() {
		...
		if (EshopHelper::isFieldPublished('zone_id'))
		{
			...
			$('#payment-address select[name=\'country_id\']').bind('change', function() {
				...
				$.ajax({
					...
					dataType: 'json',
					beforeSend: function() {
						$('#payment-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
					},
					complete: function() {
						$('.wait').remove();
					},
