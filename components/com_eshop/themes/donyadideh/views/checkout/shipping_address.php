...
<div class="uk-margin uk-float-left">
	<input type="button" class="<?php echo $btnClass; ?> btn-primary <?php echo $pullRightClass; ?>" id="button-shipping-address" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
</div>
		...
		$('#button-shipping-address').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},	
				complete: function() {
		...
		if (EshopHelper::isFieldPublished('zone_id'))
		{
			...
			$('#shipping-address select[name=\'country_id\']').bind('change', function() {
				...
				$.ajax({
					...
					beforeSend: function() {
						$('.wait').remove();
						$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
					},
					complete: function() {
						$('.wait').remove();
					},
