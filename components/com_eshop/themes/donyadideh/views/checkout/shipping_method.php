...
?>
<div class="uk-margin">
		<textarea rows="8" id="textarea" class="uk-textarea uk-form-width-large" name="comment" placeholder="<?php echo JText::_('ESHOP_COMMENT_ORDER'); ?>"><?php echo $this->comment; ?></textarea>
</div>
<div class="uk-margin uk-float-left">
	<input type="button" class="<?php echo $btnClass; ?> btn-primary <?php echo $pullRightClass; ?>" id="button-shipping-method" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
		...
		$('#button-shipping-method').click(function(){
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="components/com_eshop/assets/images/loading.svg" alt="" /></span>');
				},	
				complete: function() {
