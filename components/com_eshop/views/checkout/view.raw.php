...
class EShopViewCheckout extends EShopView
{
	...
	protected function displayPaymentAddress($tpl = null)
	{
        ...
        if (!EshopHelper::getConfigValue('enable_existing_addresses') && is_array($customer))
        {
	...
	protected function displayPaymentMethod($tpl = null)
	{
		...
		{
    		$this->checkoutTermsLink          = EshopHelper::getCheckoutTermsLink();
    		$this->privacyPolicyArticleLink   = EshopHelper::getPrivacyPolicyArticleLink();
		}
