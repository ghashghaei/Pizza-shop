	...
	<div class="row-fluid clearfix">
		...
		foreach ($items as $key => $product)
		{
			...
			$labels = $product->labels;
		 	?>
			<div class="eshop_product span<?php echo $span; ?>">
				...
				<div class="eshop-buttons">
					...
					if ($showAddquote == 1 && EshopHelper::isQuoteMode($product))
					{
					    ...
					    <div class="eshop-quote-area">
							<input id="add-to-quote-<?php echo $product->id; ?>" type="button" class="btn btn-primary"
		...
		<?php
			if (($key + 1) % $productsPerRow == 0 && $key < (count($items) - 1)) echo '</div><div class="row-fluid clearfix">';
		}
	?>
	</div>
	<?php
