...
class plgContentEshopProduct extends JPlugin
{
	...
	function displayProduct($matches)
	{
		...
		else 
		{
			...
			{
			    $item->small_thumb_image = JUri::base(true) . '/media/com_eshop/products/' . $smallThumbImage;
			}
			else
			{
			...
			{
			    $item->thumb_image = JUri::base(true) . '/media/com_eshop/products/' . $thumbImage;
			}
			else 
			{
			...
			{
			    $item->popup_image = JUri::base(true) . '/media/com_eshop/products/' . $popupImage;
			}
			else 
			{
			...
			$view->assignRef('productAttachments', $productAttachments);
			$view->assignRef('productTags', $productTags);
			...
			$view->assignRef('bootstrapHelper', $bootstrapHelper);
			ob_start();
			$view->display();
